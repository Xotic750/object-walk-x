...
function object_walk_x_esm_slicedToArray(arr, i) { return object_walk_x_esm_arrayWithHoles(arr) || object_walk_x_esm_iterableToArrayLimit(arr, i) || object_walk_x_esm_nonIterableRest(); }
...
var object_walk_x_esm_internalWalk = function internalWalk(args) {
  var _args = object_walk_x_esm_slicedToArray(args, 5),
      object = _args[0],
      props = _args[1],
      supplier = _args[2],
      thisArg = _args[3],
  ...
  if (is_array_like_x_esm(keys) === false) {
    keys = [];
  }

  var control = null;
  array_some_x_esm(keys, function predicate(prop) {
    var value = object[prop];
    control = simple_call_x_esm(supplier, thisArg, [value, prop, object, length]);
    ...
    if (array_includes_x_esm(stack, value)) {
...
object_define_properties_x_esm(object_walk_x_esm_objectWalk, {
  /**
   * @static
   * @type string
   * @default break
...
/* harmony default export */ var object_walk_x_esm = __webpack_exports__["default"] = (object_walk_x_esm_objectWalk);
...
//# sourceMappingURL=object-walk-x.js.map